...
function setUpTextures() {
  ...
  if (curTexture != 'proc') {
    var worldImage = null;
    if (curTexture == 'globe') worldImage = document.getElementById('world-texture');
    if (curTexture == 'myimage') worldImage = document.getElementById('cricket-ball-texture');
    ...
    // Read, compile, and link your shaders
    sphereGlobeProgram = initProgram('sphereMap-V', 'sphereMap-proc');
  }
